...
enough of it.}
  ...
  s.test_files = ["test/test_memory_leak.rb", "test/xml/test_node_attributes.rb", "test/xml/test_document_fragment.rb", "test/xml/test_node_set.rb", "test/xml/node/test_subclass.rb", "test/xml/node/test_save_options.rb", "test/xml/test_processing_instruction.rb", "test/xml/test_node.rb", "test/xml/test_dtd.rb", "test/xml/test_xinclude.rb", "test/xml/sax/test_parser.rb", "test/xml/sax/test_parser_context.rb", "test/xml/sax/test_push_parser.rb", "test/xml/test_parse_options.rb", "test/xml/test_element_content.rb", "test/xml/test_dtd_encoding.rb", "test/xml/test_syntax_error.rb", "test/xml/test_text.rb", "test/xml/test_node_encoding.rb", "test/xml/test_unparented_node.rb", "test/xml/test_cdata.rb", "test/xml/test_element_decl.rb", "test/xml/test_xpath.rb", "test/xml/test_reader_encoding.rb", "test/xml/test_comment.rb", "test/xml/test_attribute_decl.rb", "test/xml/test_document_encoding.rb", "test/xml/test_schema.rb", "test/xml/test_node_inheritance.rb", "test/xml/test_namespace.rb", "test/xml/test_relax_ng.rb", "test/xml/test_entity_reference.rb", "test/xml/test_c14n.rb", "test/xml/test_attr.rb", "test/xml/test_document.rb", "test/xml/test_node_reparenting.rb", "test/xml/test_builder.rb", "test/xml/test_entity_decl.rb", "test/test_convert_xpath.rb", "test/html/test_document_fragment.rb", "test/html/test_node.rb", "test/html/sax/test_parser.rb", "test/html/sax/test_parser_context.rb", "test/html/test_node_encoding.rb", "test/html/test_named_characters.rb", "test/html/test_document_encoding.rb", "test/html/test_document.rb", "test/html/test_element_description.rb", "test/html/test_builder.rb", "test/test_css_cache.rb", "test/test_encoding_handler.rb", "test/css/test_parser.rb", "test/css/test_xpath_visitor.rb", "test/css/test_tokenizer.rb", "test/css/test_nthiness.rb", "test/decorators/test_slop.rb", "test/test_soap4r_sax.rb", "test/test_nokogiri.rb", "test/xslt/test_custom_functions.rb", "test/xslt/test_exception_handling.rb", "test/test_reader.rb", "test/test_xslt_transforms.rb"]
